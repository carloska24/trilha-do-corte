...
export const AuthScreen: React.FC<AuthScreenProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('📝 [handleSubmit] AuthMode:', authMode);
    console.log('📝 [handleSubmit] Type:', type);
    console.log('📝 [handleSubmit] FormData:', { ...formData, password: '***' });
  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex flex-col items-center justify-center p-4 relative overflow-y-auto">
      ...
      <button
        onClick={onGoBack}
        type="button"
        className="absolute top-6 left-6 z-50 text-white/50 hover:text-white transition-colors cursor-pointer"
      >
        <ArrowLeft size={24} />
      </button>
      ...
      >
        ...
        <div className="bg-[#121212]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden relative">
                ...
                <div className="space-y-1 animate-[fadeIn_0.3s_ease-out]">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      type="text"
                      required
                      className="w-full bg-zinc-950 border border-white/10 rounded-lg px-10 py-2.5 text-white focus:outline-none focus:border-white/30 transition-all placeholder-gray-700 font-medium"
          ...
          {/* Footer Decoration */}
          <div className="bg-black/40 p-3 text-center border-t border-white/5 transition-colors duration-300">
