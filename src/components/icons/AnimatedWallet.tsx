...
export const AnimatedWallet: React.FC<{ className?: string }> = ({ className = '' }) => {
  return (
    <div className={`relative flex items-center justify-center ${className}`}>
      ...
      <svg
        ...
        className="w-full h-full overflow-visible drop-shadow-[0_0_15px_rgba(234,179,8,0.4)]"
      >
        {/* DEFS for Gradients */}
        <defs>
        ...
        <g className="animate-[float-slow_4s_ease-in-out_infinite]">
          {/* Path 1: Detail (Button/Clasp Center) */}
          <path
            fill="url(#goldGradient)"
            d="M253.614,333.891c-14.336,0-25.999,11.663-25.999,25.999s11.664,25.999,25.999,25.999s25.999-11.663,25.999-25.999
          ...
          {/* Path 2: Detail (Small Stitch/Highlight) */}
          <path
            fill="url(#goldGradient)"
            d="M333.878,300.75c-1.86-1.86-4.44-2.931-7.07-2.931c-2.63,0-5.21,1.07-7.07,2.931c-1.87,1.859-2.93,4.439-2.93,7.069
          ...
          {/* Path 3: Main Wallet Body + Bills */}
          <path
            fill="url(#goldGradient)"
            d="M461.994,143.987h-10.781L310.158,2.932c-3.905-3.905-10.238-3.905-14.142,0L259.88,39.069L115.356,0.344
          ...
          {/* Path 4: Detail (Small Circle/Button Highlight) */}
          <path
            fill="url(#goldGradient)"
            d="M65.076,333.318c-1.86-1.859-4.44-2.93-7.07-2.93s-5.21,1.07-7.07,2.93c-1.86,1.86-2.93,4.44-2.93,7.07
